...
import 'package:qrcode/splash_screen/splash_screen_widget.dart';
import 'flutter_flow/flutter_flow_theme.dart';
...
class _MyAppState extends State<MyApp> {
  Stream<QrcodeFirebaseUser> userStream;
  QrcodeFirebaseUser initialUser;
  ...
  void initState() {
    super.initState();
    userStream = qrcodeFirebaseUserStream()
...
class _NavBarPageState extends State<NavBarPage> {
  String _currentPage = 'Qr_scanner';
